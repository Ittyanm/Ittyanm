...
<body>
  ...
  <header>
    <p class="self-introduction">Kento Ichikawa's Design</p>
    <h1 class="top-title">Ittyanm<span class="trade">&trade;</span></h1>
    <p class="title">WebDesigner&amp;UI|UX</p>
    <p class="sentence">Design is how it works.</p>
    ...
    <aside>
      <nav>
       ...
       <span class="label">About</span>
          ...
          <li>
            <a href="./pages/work.html" target="_blank">
  ...
  <footer>
    <nav class="footer-social">
      <ul>
        <li>
          <a href="https://twitter.com/Ittyanm/" class="footer-icon" title="Twitter" target="_blank">
      <svg class="icon icon-twitter"><use xlink:href="#icon-twitter"></use></svg>
      <!--[if lt IE 9]><em>Twitter</em><![endif]-->
     </a>
        </li>
        <li>
          <a href="https://www.facebook.com/ittyanm" class="footer-icon" title="Facebook" target="_blank">
      <svg class="icon icon-facebook"><use xlink:href="#icon-facebook"></use></svg>
      <!--[if lt IE 9]><em>Facebook</em><![endif]-->
     </a>
        </li>
        <li><a href="https://www.instagram.com/ittyanm/" class="footer-icon" title="Instagram" target="_blank"><svg class="icon icon-instagram" viewBox="0 0 512 512"><g><path d="M256 109.3c47.8 0 53.4 0.2 72.3 1 17.4 0.8 26.9 3.7 33.2 6.2 8.4 3.2 14.3 7.1 20.6 13.4 6.3 6.3 10.1 12.2 13.4 20.6 2.5 6.3 5.4 15.8 6.2 33.2 0.9 18.9 1 24.5 1 72.3s-0.2 53.4-1 72.3c-0.8 17.4-3.7 26.9-6.2 33.2 -3.2 8.4-7.1 14.3-13.4 20.6 -6.3 6.3-12.2 10.1-20.6 13.4 -6.3 2.5-15.8 5.4-33.2 6.2 -18.9 0.9-24.5 1-72.3 1s-53.4-0.2-72.3-1c-17.4-0.8-26.9-3.7-33.2-6.2 -8.4-3.2-14.3-7.1-20.6-13.4 -6.3-6.3-10.1-12.2-13.4-20.6 -2.5-6.3-5.4-15.8-6.2-33.2 -0.9-18.9-1-24.5-1-72.3s0.2-53.4 1-72.3c0.8-17.4 3.7-26.9 6.2-33.2 3.2-8.4 7.1-14.3 13.4-20.6 6.3-6.3 12.2-10.1 20.6-13.4 6.3-2.5 15.8-5.4 33.2-6.2C202.6 109.5 208.2 109.3 256 109.3M256 77.1c-48.6 0-54.7 0.2-73.8 1.1 -19 0.9-32.1 3.9-43.4 8.3 -11.8 4.6-21.7 10.7-31.7 20.6 -9.9 9.9-16.1 19.9-20.6 31.7 -4.4 11.4-7.4 24.4-8.3 43.4 -0.9 19.1-1.1 25.2-1.1 73.8 0 48.6 0.2 54.7 1.1 73.8 0.9 19 3.9 32.1 8.3 43.4 4.6 11.8 10.7 21.7 20.6 31.7 9.9 9.9 19.9 16.1 31.7 20.6 11.4 4.4 24.4 7.4 43.4 8.3 19.1 0.9 25.2 1.1 73.8 1.1s54.7-0.2 73.8-1.1c19-0.9 32.1-3.9 43.4-8.3 11.8-4.6 21.7-10.7 31.7-20.6 9.9-9.9 16.1-19.9 20.6-31.7 4.4-11.4 7.4-24.4 8.3-43.4 0.9-19.1 1.1-25.2 1.1-73.8s-0.2-54.7-1.1-73.8c-0.9-19-3.9-32.1-8.3-43.4 -4.6-11.8-10.7-21.7-20.6-31.7 -9.9-9.9-19.9-16.1-31.7-20.6 -11.4-4.4-24.4-7.4-43.4-8.3C310.7 77.3 304.6 77.1 256 77.1L256 77.1z"/><path d="M256 164.1c-50.7 0-91.9 41.1-91.9 91.9s41.1 91.9 91.9 91.9 91.9-41.1 91.9-91.9S306.7 164.1 256 164.1zM256 315.6c-32.9 0-59.6-26.7-59.6-59.6s26.7-59.6 59.6-59.6 59.6 26.7 59.6 59.6S288.9 315.6 256 315.6z"/><circle cx="351.5" cy="160.5" r="21.5"/></g></svg><!--[if lt IE 9]><em>Instagram</em><![endif]--></a></li>
        <li>
          <a href="https://github.com/Ittyanm/" class="footer-icon" title="GitHub" target="_blank">
      <svg class="icon icon-github"><use xlink:href="#icon-github"></use></svg>
      <!--[if lt IE 9]><em>GitHub</em><![endif]-->
     </a>
        </li>
        <li>
          <a href="https://www.pinterest.jp/ittyanm/" class="footer-icon" title="Pinterest" target="_blank">
      <svg class="icon icon-pinterest"><use xlink:href="#icon-pinterest"></use></svg>
      <!--[if lt IE 9]><em>Pinterest</em><![endif]-->
     </a>
        </li>
        <li>
          <a href="https://plus.google.com/u/0/+%E5%B8%82%E5%B7%9D%E8%B3%A2%E4%BA%BA" class="footer-icon" title="GooglePlus" target="_blank">
      <svg class="icon icon-googleplus"><use xlink:href="#icon-googleplus"></use></svg>
      <!--[if lt IE 9]><em>GooglePlus</em><![endif]-->
     </a>
        </li>
      </ul>
    </nav>
    <a class="copy" href="mailto:ittyanm@gmail.com?subject=お問い合わせタイトルをご入力ください&body=【会社名】%0D%0A%0D%0A【*お名前】%0D%0A%0D%0A【*メールアドレス】%0D%0A%0D%0A【電話番号】%0D%0A%0D%0A【*お問い合わせ内容】%0D%0A%0D%0A%0D%0A%0D%0A*は必須項目です。">&copy;<i>Ittyanm</i>
   </a>
    <div class="fb-like" data-share="true" data-width="450" data-show-faces="true">
    </div>
  </footer>
  <svg style="display: block; width: 0; height: 0;" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
  <defs>
   ...
   <symbol id="icon-sass" viewBox="0 0 32 32">
    <title>sass</title>
    <path d="M16 0c8.836 0 16 7.164 16 16s-7.164 16-16 16-16-7.164-16-16 7.164-16 16-16zM12.82 21.33c0.234 0.86 0.208 1.664-0.032 2.39l-0.088 0.24c-0.032 0.080-0.068 0.16-0.104 0.234-0.186 0.386-0.434 0.746-0.74 1.080-0.93 1.012-2.228 1.396-2.786 1.072-0.6-0.348-0.3-1.78 0.78-2.92 1.16-1.224 2.826-2.012 2.826-2.012v-0.004l0.144-0.080zM26.036 6.85c-0.724-2.844-5.436-3.78-9.896-2.194-2.654 0.944-5.526 2.424-7.592 4.356-2.456 2.296-2.848 4.296-2.688 5.132 0.57 2.948 4.61 4.876 6.272 6.306v0.008c-0.49 0.24-4.074 2.040-4.914 3.9-0.9 1.96 0.14 3.36 0.82 3.54 2.1 0.58 4.26-0.48 5.42-2.2 1.12-1.68 1.020-3.84 0.54-4.9 0.66-0.18 1.44-0.26 2.44-0.14 2.8 0.32 3.36 2.080 3.24 2.8s-0.7 1.14-0.9 1.26c-0.2 0.12-0.26 0.16-0.24 0.24 0.020 0.12 0.12 0.12 0.28 0.1 0.22-0.040 1.46-0.6 1.52-1.96 0.060-1.72-1.58-3.64-4.5-3.6-1.2 0.020-1.96 0.12-2.5 0.34-0.040-0.060-0.080-0.1-0.14-0.14-1.8-1.94-5.14-3.3-5-5.88 0.040-0.94 0.38-3.42 6.4-6.42 4.94-2.46 8.88-1.78 9.56-0.28 0.98 2.14-2.1 6.12-7.24 6.7-1.96 0.22-2.98-0.54-3.24-0.82-0.28-0.3-0.32-0.32-0.42-0.26-0.16 0.080-0.060 0.34 0 0.5 0.16 0.4 0.78 1.1 1.86 1.46 0.94 0.3 3.24 0.48 6-0.6 3.1-1.2 5.52-4.54 4.82-7.34z"></path>
   </symbol>
   ...
   <symbol id="icon-html5" viewBox="0 0 28 32">
    <title>html5</title>
    <path d="M0 0h28l-2.546 28.75-11.486 3.25-11.42-3.25-2.548-28.75zM9.374 13l-0.31-3.624 13.412 0.004 0.308-3.496-17.568-0.004 0.93 10.68h12.168l-0.434 4.568-3.88 1.072-3.94-1.080-0.25-2.812h-3.48l0.44 5.56 7.23 1.932 7.172-1.924 0.992-10.876h-12.79z"></path>
   </symbol>
   <symbol id="icon-css3" viewBox="0 0 32 32">
    <title>css3</title>
    <path d="M2 0h28l-2.546 28.75-11.486 3.25-11.42-3.25-2.548-28.75zM24.786 5.884l-17.57-0.004 0.284 3.496 13.5 0.002-0.34 3.622h-8.854l0.318 3.432h8.244l-0.488 4.696-3.88 1.072-3.94-1.078-0.25-2.814h-3.48l0.388 5.14 7.282 2.27 7.164-2.040 1.622-17.794z"></path>
   </symbol>
   <symbol id="icon-javascript" viewBox="0 0 32 32">
    <title>javascript</title>
    <path d="M0 0h32v32h-32v-32zM29.38 24.368c-0.234-1.46-1.186-2.686-4.006-3.83-0.98-0.46-2.070-0.78-2.396-1.52-0.12-0.44-0.14-0.68-0.060-0.94 0.2-0.86 1.22-1.12 2.020-0.88 0.52 0.16 1 0.56 1.3 1.2 1.38-0.9 1.38-0.9 2.34-1.5-0.36-0.56-0.54-0.8-0.78-1.040-0.84-0.94-1.96-1.42-3.78-1.38l-0.94 0.12c-0.9 0.22-1.76 0.7-2.28 1.34-1.52 1.72-1.080 4.72 0.76 5.96 1.82 1.36 4.48 1.66 4.82 2.94 0.32 1.56-1.16 2.060-2.62 1.88-1.080-0.24-1.68-0.78-2.34-1.78l-2.44 1.4c0.28 0.64 0.6 0.92 1.080 1.48 2.32 2.34 8.12 2.22 9.16-1.34 0.040-0.12 0.32-0.94 0.1-2.2zM17.4 14.708h-2.996c0 2.584-0.012 5.152-0.012 7.74 0 1.644 0.084 3.152-0.184 3.614-0.44 0.92-1.572 0.8-2.088 0.64-0.528-0.26-0.796-0.62-1.106-1.14-0.084-0.14-0.148-0.26-0.17-0.26l-2.434 1.5c0.406 0.84 1 1.56 1.766 2.020 1.14 0.68 2.672 0.9 4.276 0.54 1.044-0.3 1.944-0.92 2.414-1.88 0.68-1.24 0.536-2.76 0.53-4.46 0.016-2.74 0-5.48 0-8.24z"></path>
   </symbol>
  </defs>
 </svg>
</body>
